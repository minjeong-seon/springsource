...
<div class="row">
	<div class="col">
		<form action="" method="post">
			...
			<!-- 로그인 사용자가 게시글 작성자와 동일한 경우에만 수정버튼 활성화 -->
		...
		<div class="form-row">
			...
			<div class="col my-2">
				<div class="form-row my-2">
					<input type="text" name="replyer" id="replyer" class="form-control" readonly value='<sec:authentication property="principal.username"/>' />
				</div>
				<div class="form-row my-2">
