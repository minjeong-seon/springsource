...
document.querySelector("#wishButton").addEventListener("click", () => {
  ...
  fetch("/api/restaurant", {
    ...
    .then((data) => {
      // 추가)이미 리스트에 존재하면 "이미 추가된 장소입니다."메시지, 아니면 "위시리스트에 추가되었습니다." 띄우기
  ...
  fetch("/api/restaurant/all")
    ...
    .then((data) => {
      ...
      data.forEach((element) => {
        ...
        str += "</div><div class='col-sm-6 col-md-4'>";
        ...
        str += "<a href='" + element.homePageLink + "'>홈페이지</a></li>";
        str += "<li class='list-group-item'>";
