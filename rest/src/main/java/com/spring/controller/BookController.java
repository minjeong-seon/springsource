...
public class BookController {
	...
	// http://localhost:8080/1001 + GET : 코드가 1001번인 도서 정보 조회
	...
	// http://localhost:8080/1001 + DELETE : 코드가 1001인 도서 정보 삭제
	@DeleteMapping("/{code}")
	...
	public ResponseEntity<String> update(@RequestBody BookDTO dto){
		...
		//service.update(dto) 결과가 true 면 success + 200 / false면 fail + 400을 리턴
