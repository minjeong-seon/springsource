...
<body>
	<div class="cotainer">
		...
		<button type="button" class="btn btn-outline-primary">도서 전체 목록</button>
		...
		<div>
			<form action='' method="post" id="insertForm">
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="code1" name="code1" placeholder="도서코드">
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="price1" name="price1" placeholder="도서가격">
				</div>
				<div class="mb-3">
