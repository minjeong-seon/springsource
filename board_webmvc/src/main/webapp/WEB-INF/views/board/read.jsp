	...
	<div class="col">
		<form action="/board/read" method="post">
			...
			<div class="form-group">
				...
				<textarea class="form-control" id="content" rows="10" name="content" placeholder="content" readonly></textarea>
			</div>
			<div class="form-group">
				<label for="writer">Writer</label> 
				<input type="text" class="form-control" id="writer" name="writer" placeholder="writer" readonly>
			</div>
