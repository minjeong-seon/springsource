...
public class StringEx {
	public static void main(String[] args) {
		...
		String str2="Hello"; //1)
		String str4="Hello";
		String str = new String("안녕하세요."); //2)
		String str3 = new String("안녕하세요.");
//		str2=str2+str;
		
		//문자열 비교
		System.out.println(str2.equals(str));
		System.out.println(str==str3); //입력값은 "안녕하세요"와 같은데 ==또한 주소값을 비교하므로 결과는 false다.
		
		//String 클래스에 equals가 오버라이딩 되어 있음(값을 비교하도록) ==> *문자열은 == 사용x
