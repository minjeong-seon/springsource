 ...
 * 	->객체에 저장된 데이터를 쓰트림에 쓰기 위해 연속적인 데이터로 변환
 * 
...
public class SerializationEx1 {
	public static void main(String[] args) {
		...
		//ObjectOutputStream : stream에 객체 출력
		try (FileOutputStream fos = new FileOutputStream("c:\\temp\\serial.dat");
				BufferedOutputStream bos = new BufferedOutputStream(fos);		//성능향상용
		...
		try (FileInputStream fis = new FileInputStream("c:\\temp\\serial.dat");
				BufferedInputStream bis = new BufferedInputStream(fis);		//성능향상용
