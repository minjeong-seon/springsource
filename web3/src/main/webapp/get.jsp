...
<form action="" method="post">
  <div class="mb-3">
   ...
   <%--  <input type="text" class="form-control" id="username" name="username"  readonly value="<%=dto.getUserusername()%>">     --%>
    <input type="text" class="form-control" id="username" name="username"  readonly value="${dto.userusername}">    
  </div>
  <div class="mb-3">
