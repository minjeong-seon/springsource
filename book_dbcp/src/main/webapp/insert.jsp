...
<form action="insertPro.jsp" method="post">
	  <div class="mb-3">
	    ...
	    <input type="text" class="form-control" id="code" name="code"  placeholder="도서코드 -4자리 숫자">    
	    <p class="multicode"></p>
	  </div>
	  <div class="mb-3">
	  ...
	  <div class="mb-3">
	    ...
	    <textarea class="form-control" id="description" name="description"  placeholder="도서 상세정보"></textarea>    
	  </div>   
